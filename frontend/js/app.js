...
function showToast(message, type = 'error') {
    ...
    if (type === 'success') {
        ...
        icon.innerHTML = '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.84 11L8 8.84L10.16 11L11 10.16L8.84 8L11 5.84L10.16 5L8 7.16L5.84 5L5 5.84L7.16 8L5 10.16L5.84 11ZM8 14C7.17 14 6.39 13.8424 5.66 13.5272C4.93 13.212 4.295 12.7846 3.755 12.245C3.215 11.7054 2.7876 11.0704 2.4728 10.34C2.158 9.6096 2.0004 8.8296 2 8C1.9996 7.1704 2.1572 6.3904 2.4728 5.66C2.7884 4.9296 3.2158 4.2946 3.755 3.755C4.2942 3.2154 4.9292 2.788 5.66 2.4728C6.3908 2.1576 7.1708 2 8 2C8.8292 2 9.6092 2.1576 10.34 2.4728C11.0708 2.788 11.7058 3.2154 12.245 3.755C12.7842 4.2946 13.2118 4.9296 13.5278 5.66C13.8438 6.3904 14.0012 7.1704 14 8C13.9988 8.8296 13.8412 9.6096 13.5272 10.34C13.2132 11.0704 12.7858 11.7054 12.245 12.245C11.7042 12.7846 11.0692 13.2122 10.34 13.5278C9.6108 13.8434 8.8308 14.0008 8 14Z" fill="#DF4A34"/></svg>';
    }
